...
<html>
<head>
	<title>HighPoint Admin Login</title>
...
<body>
    <div class="container">
    <header>
    	<h1>HPA Employee Management Portal - Admin Login</h1> 
    </header>
    
    <form action="login.php" role="form" method="post" class="form-signin"> 
        <h2 class="form-signin-heading">Login Information:</h2>
    	<fieldset>
        <label for"username" class="sr-only">User name</label>
        <input class="form-control" type="text" name="username" placeholder="Username" value="<?php echo $submitted_username; ?>" required autofocus /> 
